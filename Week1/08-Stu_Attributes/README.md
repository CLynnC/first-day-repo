...
<!-- Because global attributes are usually generally multiple and if they were all labled the same, then one could not target a specific element in order to style using CSS or otherwise, because they would all be selected, it would change them all.  -->
...
<!-- Non-Global Attributes can be used with HTML elements, these other elements can only be used with specific elements. They include [alt, href, placeholder, src, and value, etc.]  -->
---
